...
public class DateHelpers extends DateUtils {
     ...
     * 日期时间格式
     */
    public static final String FORMAT_DATE_Y2M_C = "yyMM";
    public static final String FORMAT_DATE_Y2MD_C = "yyMMdd";
    public static final String FORMAT_DATE_Y4 = "yyyy";
    public static final String FORMAT_DATE_Y4MD_C = "yyyyMMdd";
    public static final String FORMAT_TIMESTAMP_C = "yyMMddhhmmss";
    ...
    public static String toTimestamp(Date date) {
        SimpleDateFormat sdf = new SimpleDateFormat(FORMAT_TIMESTAMP_C);
    ...
    public static String getYearMonth() {
        Calendar cal = Calendar.getInstance();
        SimpleDateFormat sdf = new SimpleDateFormat(FORMAT_DATE_Y2M_C);
        return sdf.format(cal.getTime());
    }
    ...
    public static String getYearMonthDay() {
        Calendar cal = Calendar.getInstance();
        SimpleDateFormat sdf = new SimpleDateFormat(FORMAT_DATE_Y2MD_C);
        return sdf.format(cal.getTime());
    }
